...
// Per-battery support
//
// UPower.displayDevice is a synthetic aggregate. It is the right source for
// the bar icon and the overall charge level, but its cycle count and capacity
// are meaningless on a machine with more than one cell — cycles belong to a
// physical battery and cannot be summed. These helpers pick the real
// batteries out of UPower.devices so each can be rendered on its own.
// ---------------------------------------------------------------------------
